...
export { MapBody, MapFrame, MapPageOptions } from "./map"
...
export const plugins: Record<string, Record<string, (...args: unknown[]) => void>> = {
  ...
  "map": {
    MapPage: (...args: unknown[]) => { componentRegistry.setOptionOverrides("map", args[0] as Record<string, unknown>); },
  },
  "note-properties": {
...
export const MapPage = plugins["map"].MapPage
